...
Parameters:
  jid (string, required): a full JID ("70935881228289@lid", "919999900000@s.whatsapp.net") or a bare user-part ("919999900000" — assumed phone).
...
Parameters:
  to (string, required): recipient. Accepts a bare phone ("919999900000"), a full phone JID ("919999900000@s.whatsapp.net"), or a group JID ("...@g.us"). Bare strings default to @s.whatsapp.net.
